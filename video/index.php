...
<html>
  <head>
    ...
    <script type="text/javascript" src="../recursos/js/video.js"></script>

    <title>Vídeos</title>
		<meta http-equiv="content-type" content="text/html; charset=utf-8" />
		<meta name="description" content="Reportajes de boda en vídeo. Aquí puedes ver algunos videoresúmenes de nuestros reportajes" />
		<meta name="keywords" content="hqbodas, bodas, sierra, madrid, galapagar, boda, pareja, reportaje, fotografo, fotografía, video, novios, novia, novio, album, corto, pelicula, musica, especial" />
		<meta name="viewport" content="width=device-width, initial-scale=1"/>
    <link rel="alternate" hreflang="es-es" href="alternateURL"/>
    <link rel="canonical" href="http://hqbodas.com/video" />
  ...
  <body>
    <section class="galeria flex-center flex-wrap">
        <!-- Contenido añadido con javascript desde vimeo-->
    </section>
